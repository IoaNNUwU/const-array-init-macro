...
make_const_arr!(ARR1, [i32; 3], div_2);

const fn div_2(n: usize) -> i32 { n as i32 / 2 }
...
make_const_arr!(ARR2, [i32; 3], |i| i as i32 / 2);
...
make_const_arr!(ARR3, [i32; 3], |_| 4 / 2);
...
make_const_arr!(ARR5, [User; 3], |i| User { id: i as u32 });
...
make_const_arr!(ARR6, [User; 3], |_| User { id: 1 as u32 });
...
make_const_arr!(ARR7, [User; 3], create_user);
